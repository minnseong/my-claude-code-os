...
# 2. 도메인별 정책 확인 (작업 범위에 맞는 파일만 읽는다)
# cat {습관_정책}           # 루틴·체크·히스토리·통계 화면 작업 시
# cat {게이미피케이션_정책}   # XP·레벨·뱃지·미션 화면 작업 시

# 3. 디자인 명세 확인
cat {문서_루트}/design/specs/[기능명].md
...
# 7. 현재 CSS 확인
cat {리소스_루트}/static/css/style.css
```
